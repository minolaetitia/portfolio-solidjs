...
import profilePhoto from "../../assets/images/diel_ramanantsoa.jpg";

const About: Component = () => {
  return (
    <section class="bg-dark-100 flex items-center justify-center px-4 py-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div class="flex justify-center md:justify-end">
            <div class="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden shadow-lg">
              <img
                src={profilePhoto} // Remplace cette URL par la photo réelle
                alt="Fidèle RABEARIMANANA"
